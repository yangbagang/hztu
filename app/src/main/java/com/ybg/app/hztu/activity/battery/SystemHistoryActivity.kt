...
class SystemHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rl_fresh_layout.setRefreshViewHolder(BGANormalRefreshViewHolder(this@SystemHistoryActivity, true))
    ...
    companion object {
        fun start(context: Context, battery: Battery) {
            val starter = Intent(context, SystemHistoryActivity::class.java)
